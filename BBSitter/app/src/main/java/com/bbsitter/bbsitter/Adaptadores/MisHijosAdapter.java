...
public class MisHijosAdapter extends FirestoreRecyclerAdapter<Hijos, MisHijosAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public MisHijosAdapter(@NonNull FirestoreRecyclerOptions<Hijos> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull MisHijosAdapter.ViewHolder holder, int position, @NonNull Hijos hijos) {
    ...
    @NonNull
    @Override
    public MisHijosAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_mishijos, viewGroup, false);

        return new MisHijosAdapter.ViewHolder(view);
    }
